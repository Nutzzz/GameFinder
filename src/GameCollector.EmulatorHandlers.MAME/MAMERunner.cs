...
public class MAMERunner
{
    ...
    public static Process Run(IFileSystem fileSystem, string exePath, params string?[] arguments)
    {
        ...
        var strWorkingDir = "";
        var workingDir = fileSystem.Directory.GetParent(exePath);
        if (workingDir is not null)
            strWorkingDir = workingDir.ToString();
