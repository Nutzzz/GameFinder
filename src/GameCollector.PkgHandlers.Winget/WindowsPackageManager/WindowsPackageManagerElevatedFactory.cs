...
/// </remarks>
public partial class WindowsPackageManagerElevatedFactory : WindowsPackageManagerFactory
{
    ...
    private static unsafe partial int WinGetServerManualActivation_CreateInstance(
        in Guid clsid,
        in Guid iid,
        uint flags,
        out void* instance);
