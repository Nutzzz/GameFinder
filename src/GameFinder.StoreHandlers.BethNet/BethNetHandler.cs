...
using GameFinder.Deprecated.RegistryUtils;
...
{
    /// <summary>
    /// Store Handler for Bethesda.net Games. [DEPRECATED]
    /// </summary>
    [PublicAPI]
    ...
    public class BethNetHandler : AStoreHandler<BethNetGame>
    {
        ...
        private const string Launcher64RegKey = @"SOFTWARE\Bethesda Softworks\Bethesda.net";
        
        private const string Uninstall32RegKey = @"SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall";
        private const string Uninstall64RegKey = @"SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall";
